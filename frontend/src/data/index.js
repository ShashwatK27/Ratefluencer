...
// ── KPI Data ──────────────────────────────────────────────────────────────
export const kpis = [
  { label: 'Total Influencers',   value: '2,847', delta: '↑ 142 this week',       deltaType: 'up',   icon: '👥' },
...
export const recommendations = [
  {
    ...
    handle: '@cristiano',
    meta: 'Sports / Lifestyle · 627M followers · Instagram',
    badge: '👑 #1 Overall',
    ratefluencer: 94,
    growth: 91,
    authenticity: 98,
    brandMatch: 95,
    why: '✦ Highest brand match for mass-market wellness',
    ringColor: '#C8F068',
    ringOffset: 12,
    rankClass: 'rank-1',
  },
  {
    ...
    name: 'Lionel Messi',
    handle: '@leomessi',
    meta: 'Sports / Lifestyle · 503M followers · Instagram',
    badge: null,
    ratefluencer: 82,
    growth: 85,
    authenticity: 90,
    brandMatch: 88,
    why: '✦ High audience trust · Lower cost per impression',
    ringColor: '#68B8F0',
    ringOffset: 36,
    rankClass: 'rank-2',
  },
  {
    ...
    name: 'Selena Gomez',
    handle: '@selenagomez',
    meta: 'Beauty / Wellness · 429M followers · Instagram',
    badge: null,
    ratefluencer: 68,
    growth: 77,
    authenticity: 84,
    brandMatch: 92,
    why: '✦ Best fit for beauty/wellness category · High save rate',
    ringColor: '#F0C96A',
    ringOffset: 64,
    rankClass: 'rank-3',
  },

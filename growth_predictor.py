...
class GrowthPredictor:
    ...
    def _load_artifacts(self):
        ...
        try:
            self.model = joblib.load(f'growth_model_{self.model_version}.pkl')
            self.scaler = joblib.load(f'growth_scaler_{self.model_version}.pkl')
            self.features = joblib.load(f'growth_features_{self.model_version}.pkl')

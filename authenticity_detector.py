...
class AuthenticityDetector:
    ...
    def _load_artifacts(self):
        ...
        try:
            self.model = joblib.load(f'authenticity_model_{self.model_version}.pkl')
            self.features = joblib.load(f'authenticity_features_{self.model_version}.pkl')
            self.metadata = joblib.load(f'authenticity_metadata_{self.model_version}.pkl')
